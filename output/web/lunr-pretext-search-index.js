...
},
{
  "id": "problem-1",
  "level": "2",
  "url": "group-first-definitions.html#problem-1",
  "type": "Problem",
  "number": "1.12",
  "title": "",
...
},
{
  ...
  "number": "2.23",
  "title": "",
  "body": " Prove that there are group isomorphisms between the following pairs of groups: (a) , where . (b) for any integer , where .  "
},
{
  "id": "problem-39",
  "level": "2",
...
},
{
  ...
  "body": " Cosets and Equivalence Relations    For any and any g\\in G let be defined as a left coset and right coset of in , respectfully.      Let . The following facts about left cosets are equivalent for :    and belong to the same left coset of in ,     for some ,     for some ,     ,     ,     .         For , the collection of left cosets of in form a partition of , and similarly for the collection of right cosets. That is,   for all , either or      ,     ,   and similarly for right cosets. Moreover all left and right cosets have the same cardinality: for any .      If is a finite group and , then In particular the number of left cosets of in is equal to the number of right cosets of in .     Lagrange's Theorem   If is a subgroup of a finite group , then divides .      If and is a finite group, then divides .       If finite groups, the common number of left or right cosets of a subgroup in a group is denoted as and is called the of in .      Even if is not finite the number of left and right cosets of a subgroup is still the same. (Hint : consider the map and show it’s a bijection. Why is the inverse needed?)    Prove the converse to Lagrange's theorem is false: find a group and an integer such that divides the order of but does not have any subgroups of order . Hint : Take .   "
},
{
  "id": "def-coset",
  "level": "2",
...
},
{
  ...
  "number": "3.7",
  "title": "",
  "body": "   If finite groups, the common number of left or right cosets of a subgroup in a group is denoted as and is called the of in .    "
},
{
  "id": "problem-41",
  "level": "2",
...
},
{
  ...
  "body": " Normal Subgroups    A subgroup of a group is normal in , written , if for all .     Equivalent Normal Definitions   Let be a subgroup of a group . The following are equivalent: 1. [^1] 2. for all . 3. [^2] for all .     The trivial subgroups , of a group are normal.    Any subgroup of an abelian group is normal.    For any group , .    Being a normal subgroup is not a transitive relation. For example, for one can show that and, since is abelian (all groups with 4 elements are abelian), the subgroup is normal in . But is {} normal in , since for example     Prove that if is a group homomorphism and then the preimage of , , is a normal subgroup of . 2. Show that if is a group homomorphism and then need not be a normal subgroup of .    Show that any subgroup of index two is normal. This means: show that if is a group, is a subgroup and , i.e the number of left (or right) cosets of in is two, then is normal.    Let be a subgroup and . (a) Prove that is a subgroup of . (b) Prove that (c) Suppose and is the only subgroup of of order . Prove that is normal.    Let and be normal subgroups of a group such that . Prove that for all .    Let be a group and a subset of . Let . Prove that if and only if for every and .    Let be a group and let be a set. The {}, denoted , is the intersection of all the normal subgroups of that contain . 1. Show that is a normal subgroup of . 2. Show that the elements of can be described as     Let be a group, , and . Prove that .    Let be a group with subgroups . Recall the notation (a) Prove that if and only if . (b) Prove that if either one of or is a normal subgroup of , then and .    In [^1], let and . Then but of course and do not commute. The fact that can also be justified by observing that .    Let be a subgroup of and fix some element . (a) Prove that is a subgroup of of the same order as . (b) Deduce that if is the unique subgroup of of order then .    Let be a group and be its automorphism group. In Problem 7 on HW # 2, you proved that for each , the function defined by for all is an automorphism of . Further, you proved the set , called the set of inner automorphisms of , is a subgroup of . Prove that .    Let be a finite group. Prove that the number of elements in the set is even. Conclude that a group of even order must have an element of order .    Let be a finite group, and subgroups such that and = are relatively prime and . Prove that .    Let be a group. A subgroup of is called a characteristic subgroup of if for every automorphism of . Show that if is a characteristic subgroup of and is a normal subgroup of , then is a normal subgroup of .    Let be a group with a subgroup so that . (a) Prove that there is a normal subgroup of , so that and (b) Prove that if is finitely generated, there are most finitely many subgroups with index .(Hint: you might want to consider maps .)   "
},
{
...
},
{
  ...
  "body": " Equivalent Normal Definitions   Let be a subgroup of a group . The following are equivalent: 1. [^1] 2. for all . 3. [^2] for all .   "
},
{
  "id": "problem-43",
  "level": "2",
  "url": "sec-normal-subgroups.html#problem-43",
  "type": "Problem",
  "number": "3.12",
  "title": "",
  "body": " The trivial subgroups , of a group are normal.  "
},
{
  "id": "problem-44",
  "level": "2",
  "url": "sec-normal-subgroups.html#problem-44",
  "type": "Problem",
  "number": "3.13",
  "title": "",
  "body": " Any subgroup of an abelian group is normal.  "
},
{
  "id": "problem-45",
  "level": "2",
...
},
{
  ...
  "number": "3.15",
  "title": "",
  "body": " Being a normal subgroup is not a transitive relation. For example, for one can show that and, since is abelian (all groups with 4 elements are abelian), the subgroup is normal in . But is {} normal in , since for example   "
},
{
  "id": "problem-47",
  "level": "2",
  ...
  "number": "3.16",
  "title": "",
  "body": " Prove that if is a group homomorphism and then the preimage of , , is a normal subgroup of . 2. Show that if is a group homomorphism and then need not be a normal subgroup of .  "
},
{
  "id": "problem-48",
  "level": "2",
...
},
{
  ...
  "number": "3.18",
  "title": "",
  "body": " Let be a subgroup and . (a) Prove that is a subgroup of . (b) Prove that (c) Suppose and is the only subgroup of of order . Prove that is normal.  "
},
{
  "id": "problem-50",
  "level": "2",
...
},
{
  ...
  "number": "3.21",
  "title": "",
  "body": " Let be a group and let be a set. The {}, denoted , is the intersection of all the normal subgroups of that contain . 1. Show that is a normal subgroup of . 2. Show that the elements of can be described as   "
},
{
  "id": "problem-53",
  "level": "2",
...
},
{
  ...
  "number": "3.23",
  "title": "",
  "body": " Let be a group with subgroups . Recall the notation (a) Prove that if and only if . (b) Prove that if either one of or is a normal subgroup of , then and .  "
},
{
  "id": "problem-55",
  "level": "2",
  ...
  "number": "3.24",
  "title": "",
  "body": " In [^1], let and . Then but of course and do not commute. The fact that can also be justified by observing that .  "
},
{
  "id": "problem-56",
  "level": "2",
  ...
  "number": "3.25",
  "title": "",
  "body": " Let be a subgroup of and fix some element . (a) Prove that is a subgroup of of the same order as . (b) Deduce that if is the unique subgroup of of order then .  "
},
{
  "id": "problem-57",
  "level": "2",
...
},
{
  ...
  "number": "3.29",
  "title": "",
  "body": " Let be a group. A subgroup of is called a characteristic subgroup of if for every automorphism of . Show that if is a characteristic subgroup of and is a normal subgroup of , then is a normal subgroup of .  "
},
{
  "id": "problem-61",
  "level": "2",
...
},
{
  ...
  "level": "2",
  "url": "sec-self-conjugation.html#def-conjugacy-class",
  "type": "Definition",
  "number": "4.16",
  "title": "",
...
},
{
  "id": "def-conjugate",
  "level": "2",
  "url": "sec-self-conjugation.html#def-conjugate",
  "type": "Definition",
  "number": "4.17",
  "title": "",
...
},
{
  ...
  "level": "2",
  "url": "sec-self-conjugation.html#prop-normal-conjugacy",
  "type": "Proposition",
  "number": "4.18",
  "title": "",
...
},
{
  "id": "problem-64",
  "level": "2",
  "url": "sec-pgroups.html#problem-64",
  "type": "Problem",
  "number": "5.5",
  "title": "",
...
},
{
  "id": "problem-65",
  "level": "2",
  "url": "sec-pgroups.html#problem-65",
  "type": "Problem",
  "number": "5.6",
  "title": "",
...
},
{
  "id": "problem-66",
  "level": "2",
  "url": "sec-simple-groups.html#problem-66",
  "type": "Problem",
  "number": "5.12",
  "title": "",
...
},
{
  "id": "problem-67",
  "level": "2",
  "url": "sec-simple-groups.html#problem-67",
  "type": "Problem",
  "number": "5.14",
  "title": "",
...
},
{
  "id": "problem-68",
  "level": "2",
  "url": "sec-group-rings-and-modules.html#problem-68",
  "type": "Problem",
  "number": "24.12",
  "title": "",
...
},
{
  "id": "problem-69",
  "level": "2",
  "url": "sec-chain-conditions.html#problem-69",
  "type": "Problem",
  "number": "26.6",
  "title": "",
...
},
{
  "id": "problem-70",
  "level": "2",
  "url": "ch-semisimple-mod.html#problem-70",
  "type": "Problem",
  "number": "27.5",
  "title": "",
...
},
{
  "id": "problem-71",
  "level": "2",
  "url": "sec-art-wedd.html#problem-71",
  "type": "Problem",
  "number": "28.17",
  "title": "",
